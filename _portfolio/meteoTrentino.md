...
As part of a group consisting of four individuals with backgrounds in engineering and physics, we developed an LSTM model. The model can be found [here](https://github.com/eliazonta/AI-Challenge-HIT-2022). We reduced from 1 week to 2 days to detect anomalies.